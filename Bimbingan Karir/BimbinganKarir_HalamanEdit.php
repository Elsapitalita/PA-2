...
$query = mysqli_query($db,"SELECT * FROM  bimbingan_karir where id_kegiatan =  $_GET[id]");
    ...
    <div class="wrapper">
        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled components">
                ...
                <li>
                    <a href="../Instrumen%20Tracer%20Study/InstrumentTracerStudy_TampilanAwal.php">
                        <i class="fas fa-fw fa-toolbox"></i>Instrumen Tracer
                        Study
                    </a>
                </li>
                <li>
        ...
        <div id="content"  >
            ...
            <nav class="breadcrumb-container" aria-label="breadcrumb">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item" aria-current="page"><a a href="BimbinganKarir_TampilanAwal.php">Bimbingan Karir dan Informasi Kerja</a></li>
            ...
            <div class="container">
                <form action="../Function/Bimbingan/updatebimbingan.php" method="post" enctype="multipart/form-data">
