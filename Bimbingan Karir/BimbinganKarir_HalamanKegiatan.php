        ...
        <div id="content"  >
            ...
            <nav class="breadcrumb-container" aria-label="breadcrumb brea">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item" aria-current="page"><a href="BimbinganKarir_TampilanAwal.php">Bimbingan Karir dan Informasi Kerja</a></li>
            ...
            <div class="container">
                ...
                <div class="form">
                    ...
                    <div class="row">
                        <div class="col-md-2"><a href="BimbinganKarir_HalamanEdit.php?id=<?php echo $_GET['id']?>"><button style="background-color: #007AC7;color: white" class="btn"><i class="fas fa-fw fa-edit"></i>Edit</button></a></div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            ?>
                            <form  action="../Function/updatetanda.php" method="post" >
