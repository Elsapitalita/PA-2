        ...
        <div id="content"  >
            ...
            <nav class="breadcrumb-container" aria-label="breadcrumb brea">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item" aria-current="page"><a href="BimbinganKarir_TampilanAwal.php"> Karir dan Informasi Kerja</a></li>
            ...
            <div class="container">
                <form action="../Function/Bimbingan/tambahbimbingan.php" method="post" enctype="multipart/form-data">
                    <div class="form">
                    <center><h2>Form Tambah Kegiatan Bimbingan Informasi Kerja</h2></center>
