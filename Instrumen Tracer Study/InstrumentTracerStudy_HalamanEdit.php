            ...
            <nav class="breadcrumb-container" aria-label="breadcrumb brea">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item" aria-current="page"><a href="InstrumentTracerStudy_TampilanAwal.php">Instrumen Tracer Study</a></li>
                    <li class="breadcrumb-item" aria-current="page"><a href="InstrumentTracerStudy_HalamanKegiatan.php?id=<?php echo $ids?>"><?php echo $data[1]?></a></li>
                    <li class="breadcrumb-item active" aria-current="page">Edit Kegiatan</li>
                </ol>
              
            </nav>
            <div class="container">
                <form action="../Function/Instrumen%20Tracer%20Study/updateinstrumen.php" method="post" enctype="multipart/form-data">
