...
?>
    <div class="wrapper">
        ...
        <div id="content"  >
            ...
            <div class="container">
                <form action="../Function/Instrumen%20Tracer%20Study/tambahinstrumen.php" method="post" enctype="multipart/form-data">
                <div class="form">
                    <center><h2>Form Tambah Waktu Instrumen Tracer Study</h2></center>
