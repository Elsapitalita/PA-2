...
$query = mysqli_query($db,"SELECT * FROM  instrumen_tracer_study");
$query2 = mysqli_query($db,"SELECT COUNT(STATUS) FROM instrumen_tracer_study WHERE STATUS = 'Telah Dilaksanakan'");
        ...
        <div id="content"  >
            ...
            <nav class="breadcrumb-container" aria-label="breadcrumb brea">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">Instrumen Tracer Study</li>
                </ol>
            ...
            <div class="container-fluid">
                ...
                <div class="keterangan">
                    <div class="indikator-utama">
                        <center><h1>Instrumen Tracer Study</h1></center>    
                    </div>
                    <div class="lainnya">
                    <h5>Indikator Kerja Utama</h5>
                    <span>
                        Kesesuaian bidang kerja lulusan dengan bidang studi(instrumen tracer study)                        
                    </span>
                    <hr>        
                    <h5>Indikator Kerja Kegiatan</h5>
                    <span>Pelaksanaan setiap tahun<br>
                    </span>
                    <hr>
                    ...
                    <a href="InstrumentTracerStudy_TambahKegiatan.php"><button class="btn btn-primary">+ Tambah Kegiatan</button></a>
                    <table class="table table-striped table-bordered" style="margin-top: 30px; text-align: center">
                        ...
                        <?php foreach (mysqli_fetch_all($query) as $x){ ?>
                            <tr>
                                ...
                                <td><a href="InstrumentTracerStudy_HalamanKegiatan.php?id=<?php echo $x[0];?>" style="color: blue;"><?php echo $x[1]?></a></td>
