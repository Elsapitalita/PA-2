...
$query = mysqli_query($db,"SELECT * FROM  partisipasi_alumni where id_kegiatan =  $_GET[id]");
        ...
        <div id="content"  >
            ...
            <nav class="breadcrumb-container" aria-label="breadcrumb brea">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item" aria-current="page"><a href="PartisipasiAlumni_TampilanAwal.php"> Partisipasi Alumni</a></li>
                  <li class="breadcrumb-item active" aria-current="page">Edit Kegiatan</li>
                </ol>
              
            </nav>
            <div class="container">
                <form action="../Function/Partisipasi%20Alumni/updatepartisipasi.php" method="post" enctype="multipart/form-data">
