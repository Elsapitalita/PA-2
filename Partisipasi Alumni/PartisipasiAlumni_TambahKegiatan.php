...
?>
    <div class="wrapper">
        ...
        <div id="content"  >
            ...
            <div class="container">
                <form action="../Function/Partisipasi%20Alumni/tambahpartisipasi.php" method="post" enctype="multipart/form-data">
                <div class="form">
                    <center><h2>Form Tambah Kegiatan Partisipasi Alumni</h2></center>
