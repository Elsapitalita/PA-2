...
$query = mysqli_query($db,"SELECT * FROM  partisipasi_alumni");
$query2 = mysqli_query($db,"SELECT COUNT(STATUS) FROM partisipasi_alumni WHERE STATUS = 'Telah Dilaksanakan'");
    ...
    <div class="wrapper">
        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled components">
                ...
                <li class="active">
                    <a href="PartisipasiAlumni_TampilanAwal.php">
        ...
        <div id="content"  >
            ...
            <nav class="breadcrumb-container" aria-label="breadcrumb brea">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">Partisipasi Alumni</li>
                </ol>
            ...
            <div class="container-fluid">
                ...
                <div class="keterangan">
                    <div class="indikator-utama">
                        <center><h1>Partisipasi Alumni </h1></center>    
                    </div>
                    <div class="lainnya">
                    <h5>Indikator Kerja Utama</h5>
                    <span>(1)Sumbangan dana <br>
                        (2)Sumbangan fasilitas <br>
                        (3)Masukan untuk perbaikan proses pembelajaran <br>
                        (4)Pengembangan jejaring <br>
                    </span>
                    <hr>        
                    <h5>Indikator Kerja Kegiatan</h5>
                    <span>Menjalin kerjasama dengan ikatan alumni</span>
                    <hr>
                    ...
                    <a href="PartisipasiAlumni_TambahKegiatan.php"><button class="btn btn-primary">+ Tambah Kegiatan</button></a>
                    <table class="table table-striped table-bordered" style="margin-top: 30px;text-align: center">
                        ...
                        <?php foreach (mysqli_fetch_all($query) as $x){ ?>
                            <tr>
                                ...
                                <td><a href="PartisipasiAlumni_HalamanKegiatan.php?id=<?php echo $x[0];?>" style="color: blue;"><?php echo $x[1]?></a></td>
