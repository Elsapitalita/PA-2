        ...
        <div class="lainnya">
            ...
            <div class="row" id="profilpict">
                <div class="col-md-4 col-sm-6">
                    <div class="row">
                        <img src="img/<?php echo $data[4] ?>" style="margin-left: 70px; height: 200px" width="200px">
                    </div>

                    <div class="row">
                        <a class="" style="" id="tes" href="UbahProfile.php">Ubah Profil</a>
                    </div>
                ...
                <div class="col-md-8 col-sm-6 text-left">
                    <div class="row">
                        ...
                        <div class="col-md-7 col-sm-3">
                            <p id="informasi">: <?php echo  $data[2]?></p>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-7 col-sm-3">
                            <p id="informasi">: <?php echo  $data[0]?></p>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-7 col-sm-3">
                            <p id="informasi">: <?php echo  $data[1]?></p>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-7 col-sm-3">
                            <p id="informasi">: <?php echo  $data[3]?></p>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-7 col-sm-3">
                            <p id="informasi">: <?php echo  $data[5]?></p>
                        </div>
                    </div>
                </div>
            </div>
