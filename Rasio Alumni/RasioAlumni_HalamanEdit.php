...
$query = mysqli_query($db,"SELECT * FROM  rasio_alumni where id_kegiatan =  $_GET[id]");
    ...
    <div id="content"  >
        ...
        <nav class="breadcrumb-container" aria-label="breadcrumb brea">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page"><a href="RasioAlumni_TampilanAwal.php">Rasio Alumni</a></li>
                <li class="breadcrumb-item" aria-current="page"><a href="RasioAlumni_HalamanKegiatan.php?id=<?php echo $ids?>"><?php echo $data[1]?></a></li>
        ...
        <div class="container">
            ...
            <form action="../Function/Rasio%20Alumni/updaterasio.php" method="post" enctype="multipart/form-data">
