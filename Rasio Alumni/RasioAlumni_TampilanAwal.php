...
$query = mysqli_query($db,"SELECT * FROM  rasio_alumni");
$query2 = mysqli_query($db,"SELECT COUNT(STATUS) FROM rasio_alumni WHERE STATUS = 'Telah Dilaksanakan'");
...
<div class="wrapper">
    ...
    <nav id="sidebar">
        ...
        <ul class="list-unstyled components">
            ...
            <li class="active">
                <a href="RasioAlumni_TampilanAwal.php">
...
<nav class="breadcrumb-container" aria-label="breadcrumb brea">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Rasio Alumni</li>
    </ol>
...
<div class="container-fluid">
    ...
    <div class="keterangan">
        <div class="indikator-utama">
            <center><h1>Rasio Alumni</h1></center>
        </div>
        <div class="lainnya">
            <h5>Indikator Kerja Utama</h5>
            <span>Rasio alumni dalam 5 tahun terakhir yang memberikan respon terhadap studi pelacakan</span>
            <hr>
            <h5>Indikator Kerja Kegiatan</h5>
            <span>Minimum 30% alumni memberikan respon terhadap studi pelacakan</span>
            <hr>
            ...
            <a href="RasioAlumni_TambahKegiatan.php"><button class="btn btn-primary">+ Tambah Kegiatan</button></a>
            <table class="table table-striped table-bordered" style="margin-top: 30px; text-align: center">
                ...
                <?php foreach (mysqli_fetch_all($query) as $x){ ?>
                    <tr>
                        ...
                        <td><a href="RasioAlumni_HalamanKegiatan.php?id=<?php echo $x[0];?>" style="color: blue;"><?php echo $x[1]?></a></td>
