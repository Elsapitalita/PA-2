...
$query = mysqli_query($db,"SELECT * FROM  tingkat_kepuasan_alumni where id_kegiatan =  $_GET[id]");
...
<div class="wrapper">
    ...
    <nav id="sidebar">
        ...
        <ul class="list-unstyled components">
            ...
            <li class="active">
                <a href="TingkatKepuasanAlumni_TampilanAwal.php">
    ...
    <div id="content"  >
        ...
        <nav class="breadcrumb-container" aria-label="breadcrumb brea">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page"><a href="TingkatKepuasanAlumni_TampilanAwal.php">Tingkat Kepuasan Alumni</a></li>
                <li class="breadcrumb-item" aria-current="page"><a href="TingkatKepuasanAlumni_HalamanKegiatan.php?id=<?php echo $ids?>"><?php echo $data[1]?></a></li>
        ...
        <div class="container">
            ...
            <form action="../Function/Tingkat%20Kepuasan%20Alumni/updatetingkat.php" method="post" enctype="multipart/form-data">
