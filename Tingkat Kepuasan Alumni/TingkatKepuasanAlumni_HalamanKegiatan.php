    ...
    <div id="content"  >
        ...
        <div class="container">
            <div class="form">
                ...
                <div class="row">
                    <div class="col-md-2"><a href="TingkatKepuasanAlumni_HalamanEdit.php?id=<?php echo $_GET['id']?>"><button style="background-color: #007AC7;color: white" class="btn"><i class="fas fa-fw fa-edit"></i>Edit</button></a></div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        ?>
                        <form  action="../Function/Tingkat%20Kepuasan%20Alumni/updatetanda.php" method="post" >
