...
<div class="wrapper">
    ...
    <div id="content"  >
        ...
        <div class="container">
            <form action="../Function/Tingkat%20Kepuasan%20Alumni/tambahtingkat.php" method="post" enctype="multipart/form-data">
            <div class="form">
                <center><h2>Form Tambah Data Tingkat Kepuasan Alumni</h2></center>
