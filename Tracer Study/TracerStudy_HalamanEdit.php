...
$query = mysqli_query($db,"SELECT * FROM  tracer_study where id_kegiatan =  $_GET[id]");
...
<nav class="breadcrumb-container" aria-label="breadcrumb brea">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item" aria-current="page"><a href="TracerStudy_TampilanAwal.php">Tracer Study</a></li>
        <li class="breadcrumb-item" aria-current="page"><a href="TracerStudy_HalamanKegiatan.php?id=<?php echo $ids?>"><?php echo  $data[1]?></a></li>
        <li class="breadcrumb-item active" aria-current="page">Edit</li>
    </ol>

</nav>
<div class="container">
    <form action="../Function/Tracer%20Study/updatetracer.php" method="post" enctype="multipart/form-data">
