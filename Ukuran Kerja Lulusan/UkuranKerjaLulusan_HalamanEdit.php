...
$query = mysqli_query($db,"SELECT * FROM  ukuran_kerja_lulusan where id_kegiatan =  $_GET[id]");
    ...
    <div id="content"  >
        ...
        <nav class="breadcrumb-container" aria-label="breadcrumb brea">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page"><a href="UkuranKerjaLulusan_TampilanAwal.php">Ukuran Kerja Lulusan</a></li>
                <li class="breadcrumb-item" aria-current="page"><a href="UkuranKerjaLulusan_HalamanKegiatan.php?id=<?php echo $ids?>">Pelaksanaan Campus Hiring</a></li>
                <li class="breadcrumb-item active" aria-current="page">Edit</li>
            </ol>

        </nav>
        <div class="container">
            <form action="../Function/Ukuran%20Kerja%20Lulusan/updateukuran.php" method="post" enctype="multipart/form-data">
                <input class="form-control" name="id" type="text" value="<?php echo $_GET['id']?>" hidden>
                <div class="form">
                    <center><h2><?php echo $data[1] ?></h2></center>
                    <div class="row" style="margin-top: 30px;">
                        <div class="col-md-3">Judul</div>
                        <div class="col-md-9"><input class="form-control" type="text" value="<?php echo $data[1]?>" name="judul"></div>
                    </div>
                    <div class="row">
                        <div class="col-md-3">Pengada</div>
                        <div class="col-md-9"><input class="form-control" type="text" value="<?php echo $data[4]?>" name="pengada"></div>
                    </div>
                    <div class="row">
                        <div class="col-md-3">Lokasi</div>
                        <div class="col-md-9"><input class="form-control" type="text" value="<?php echo $data[5] ?>" name="lokasi"></div>
                    </div>
                    <div class="row">
                        <div class="col-md-3">Tanggal</div>
                        <div class="col-md-9"><input class="form-control" type="date"  value="<?php echo $data[6] ?>" name="tanggal"></div>
                    </div>
                    <div class="row">
                        <div class="col-md-3">File Keterangan Biaya</div>
                        <div class="col-md-9" style="color: blue;"><input class="form-control" type="file" value="" name="biaya">File yang sudah ada : <?php echo $data[3] ?></div>
                    </div>
                    <div class="row">
                        <div class="col-md-3">File Terlampir</div>
                        <div class="col-md-9" style="color: blue;"><input class="form-control" type="file" name="terlampir" >File yang sudah ada : <?php echo $data[2] ?></div>
                    </div>
                    <div class="row">
                        <div class="col-md-10"></div>
                        <div class="col-md-2"><button class="btn btn-success" style="margin-right: 1%;" name="simpan">Simpan</button><button class="btn btn-danger">Batal</button></div>
                    </div>
