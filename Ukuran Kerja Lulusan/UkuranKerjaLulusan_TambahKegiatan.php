...
<div class="wrapper">
    ...
    <div id="content"  >
        ...
        <div class="container">
            <form action="../Function/Ukuran%20Kerja%20Lulusan/tambahukuran.php" method="post" enctype="multipart/form-data">
            <div class="form">
                <center><h2>Form Tambah Data Ukuran Kerja Lulusan</h2></center>
