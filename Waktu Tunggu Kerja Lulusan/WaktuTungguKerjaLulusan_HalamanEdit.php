...
$query = mysqli_query($db,"SELECT * FROM  waktu_tunggu_kerja_lulusan where id_kegiatan =  $_GET[id]");
...
?>
    <div class="wrapper">
        ...
        <div id="content"  >
            ...
            <div class="container">
                <form action="../Function/Waktu%20Tunggu%20Kerja%20Lulusan/updatewaktu.php" method="post" enctype="multipart/form-data">
