...
$query = mysqli_query($db,"SELECT * FROM  waktu_tunggu_kerja_lulusan");
$query2 = mysqli_query($db,"SELECT COUNT(STATUS) FROM waktu_tunggu_kerja_lulusan WHERE STATUS = 'Telah Dilaksanakan'");
        ...
        <div id="content"  >
            ...
            <nav class="breadcrumb-container" aria-label="breadcrumb brea">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">Waktu Tunggu Kerja Lulusan</li>
                </ol>
            ...
            <div class="container-fluid">
                ...
                <div class="keterangan">
                    <div class="indikator-utama">
                        <center><h1>Waktu Tunggu Kerja Lulusan</h1></center>    
                    </div>
                    <div class="lainnya">
                    <h5>Indikator Kerja Utama</h5>
                    <span>
                        Waktu tunggu lulusan untuk bekerja(mendapatkan pekerjaan atau berwirausaha) yang relevan dengan bidang study
                    </span>
                    <hr>        
                    <h5>Indikator Kerja Kegiatan</h5>
                    <span>(1)penyelenggaraan instrumen tracer study<br>
                        (2)Pelaksanaan tracer study <br>
                        (3)Sosialiasi tracer study <br>
                    </span>
                    <hr>
                    ...
                    <a href="WaktuTungguKerjaLulusan_TambahKegiatan.php"><button class="btn btn-primary">+ Tambah Kegiatan</button></a>
                    <table class="table table-striped table-bordered" style="margin-top: 30px;text-align: center;">
                        <thead>
                          <tr class="table-primary">
                            <th scope="col">No</th>
                            <th scope="col judul" style="width: 450px;">Judul Kegiatan</th>
                        ...
                        <?php foreach (mysqli_fetch_all($query) as $x){ ?>
                            <tr>
                                ...
                                <td><a href="WaktuTungguKerjaLulusan_HalamanKegiatan.php?id=<?php echo $x[0];?>" style="color: blue;"><?php echo $x[1]?></a></td>
